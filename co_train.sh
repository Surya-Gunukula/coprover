...
check_workspace() {
    ...
    # Training scripts
    for script in training/train_step_grpo.sh training/train_value_slime.sh data/trajectory_collector.py eval/evaluate.py; do
...
build_args() {
    CO_TRAIN_ARGS=(
        ...
        --grpo-script "${TRAINING_DIR}/training/train_step_grpo.sh"
        --value-script "${TRAINING_DIR}/training/train_value_slime.sh"
