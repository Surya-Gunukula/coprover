...
class CoTrainConfig:
    ...
    # Scripts
    grpo_script: str = "/workspace/training/training/train_step_grpo.sh"
    value_script: str = "/workspace/training/training/train_value_slime.sh"
    trajectory_script: str = "/workspace/training/data/trajectory_collector.py"
    evaluate_script: str = "/workspace/training/eval/evaluate.py"
...
def parse_args() -> CoTrainConfig:
    ...
    cfg = CoTrainConfig(
        ...
        grpo_script=args.grpo_script or f"{args.base_dir}/training/train_step_grpo.sh",
        value_script=args.value_script or f"{args.base_dir}/training/train_value_slime.sh",
        trajectory_script=f"{args.base_dir}/data/trajectory_collector.py",
        evaluate_script=f"{args.base_dir}/eval/evaluate.py",
